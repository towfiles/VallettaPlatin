...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\ApiBaseController' => 'getApiBaseControllerService.php',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['App\\AppBundle\\EventListener\\ApiExceptionSubscriber'] ?? ($this->privates['App\\AppBundle\\EventListener\\ApiExceptionSubscriber'] = new \App\AppBundle\EventListener\ApiExceptionSubscriber()));
        }, 1 => 'onKernelException'], 0);
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['api_exception_subscriber'] ?? ($this->privates['api_exception_subscriber'] = new \App\AppBundle\EventListener\ApiExceptionSubscriber()));
        }, 1 => 'onKernelException'], 0);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'FourSquareApiAdapterBundle' => [
                    'path' => ($this->targetDirs[3].'/src/AppBundle/FourSquareApiAdapterBundle'),
                    'namespace' => 'App\\AppBundle\\FourSquareApiAdapterBundle',
                ],
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'FourSquareApiAdapterBundle' => 'App\\AppBundle\\FourSquareApiAdapterBundle\\FourSquareApiAdapterBundle',
            ],
